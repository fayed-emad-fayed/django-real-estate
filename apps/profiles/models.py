...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=_("Phone Number"), max_length=30, default="+201097208244"
    )
    ...
    gender = models.CharField(
        verbose_name=_("Gender"), choices=Gender.choices, default="", max_length=6
    )
    country = CountryField(
        verbose_name=_("Country"), default="SA", blank=False, null=False
    )
    city = models.CharField(
        verbose_name=_("City"), max_length=180, default="", blank=False, null=False
    )
