...
class Property(TimeStampedUUIDModel):
    ...
    description = models.TextField(verbose_name=_("Description"), default="Default Description....update this")
    country = CountryField(verbose_name=_("Country"), default="KSA", blank_label="(Select Country)")
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Mekka")
    ...
    property_num = models.IntegerField(verbose_name=_("Property Number"), validators=[MinValueValidator(1)], default=112)
    price = models.DecimalField(verbose_name=_("Price"), max_digits=8, decimal_places=2, default=0.0)
    last_price = models.DecimalField(verbose_name=_("Last_Price"), max_digits=8, decimal_places=2, default=0.0)
    tax = models.DecimalField(verbose_name=_("Property Tax"), max_digits=6, decimal_places=2, default=0.10, help_text="10% property tax charge")
    plot_area = models.DecimalField(verbose_name=_("Plot Area In Squared meter(m^2)"), max_digits=8, decimal_places=2, default=0.0)
    ...
    photo1 = models.ImageField(default="/img1.jpg", null=True, blank=True)
    photo2 = models.ImageField(default="/img1.jpg", null=True, blank=True)
    ...
    def final_property_price(self):
        ...
        tax = round(property_price * tax_percentage, 2)
        price_after_tax = float(round(property_price + tax, 2))
